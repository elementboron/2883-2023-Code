...
public final class Constants {
  ...
  public static final double LEFT_FRONT_STEER_OFFSET = -Math.toRadians(181); // Measure and set front left steer offset
  ...
  public static final double RIGHT_REAR_STEER_OFFSET = -Math.toRadians(32); // Measure and set back right steer offset
