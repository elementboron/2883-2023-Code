...
public class SwerveTrajectoryAction implements Action {
  ...
  public SwerveTrajectoryAction(
    ...
    mLimelight = LimelightReader.Instance;

    m_trajectory = RequireNonNullExtension.requireNonNullParam(trajectory, "trajectory", "SwerveTrajectoryAction");
    m_pose = RequireNonNullExtension.requireNonNullParam(pose, "pose", "SwerveTrajectoryAction");
    m_kinematics = RequireNonNullExtension.requireNonNullParam(kinematics, "kinematics", "SwerveTrajectoryAction");

    m_controller =
        new HolonomicDriveController(
          RequireNonNullExtension.requireNonNullParam(xController, "xController", "SwerveTrajectoryAction"),
          RequireNonNullExtension.requireNonNullParam(yController, "xController", "SwerveTrajectoryAction"),
          RequireNonNullExtension.requireNonNullParam(thetaController, "thetaController", "SwerveTrajectoryAction"));

    m_outputModuleStates =
    RequireNonNullExtension.requireNonNullParam(outputModuleStates, "frontLeftOutput", "SwerveTrajectoryAction");

    m_desiredRotation =
    RequireNonNullExtension.requireNonNullParam(desiredRotation, "desiredRotation", "SwerveTrajectoryAction");

    m_wantsVisionAlign = 
    RequireNonNullExtension.requireNonNullParam(wantsVisionAlign, "wantsVisionAlign", "SwerveTrajectoryAction");
  }
